...
# print(is_English(  clean_text("I will do my best for you !! ha" )   ))
# print(is_English(  "HAPPY BIRTHDAY BUMBAY   ".lower()               ))
# print(is_English(  "Le client est très important merci"             ))
# print(is_English(  "WHAT FUCKING LANGUAGE IS MY FUCKING PHONE IN"   ))  # All-Caps Text will be detected as German. 
